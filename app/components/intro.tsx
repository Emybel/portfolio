...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        Hey there, <span className="font-bold">I'm Imane.</span> a budding{" "}
        ...
        . I love building{" "}
        <span className="font-bold">sleek and interactive </span> websites and
        applications to create engaging user experiences.
      </motion.h1>
